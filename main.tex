...
\usepackage{float}            % Para posicionamento forçado de figuras
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{diagramas/Diagramas de casos de uso/diagrama-geral.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{diagramas/Diagramas de casos de uso/diagrama-fila.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{diagramas/Diagramas de casos de uso/diagrama-estoque.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{diagramas/Diagramas de casos de uso/diagrama-nutricao.png}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth]{\includegraphics[width=1.0\textwidth]{diagramas/Diagramas de classe/QualidadeENutricao- Analise.jpg}}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth]{\includegraphics[width=1.2\textwidth]{diagramas/Diagramas de classe/QualidadeENutricao- Projeto.jpg}}
...
Esta seção apresenta os diagramas de máquina de estados, que modelam o comportamento dinâmico de objetos específicos do sistema.

\subsection{Módulo Estoque}
As Figuras~\ref{fig:estado_estoque} e~\ref{fig:estado_estoque_ru} apresentam os estados de um pedido de insumos e do RU, respectivamente.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{diagramas/Diagramas de estado/Diagrama Pedido Estados.jpg}
    \caption{Diagrama de estados - Módulo Estoque (Pedido)}
    \label{fig:estado_estoque}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{diagramas/Diagramas de estado/Diagrama RU Estados.png}
    \caption{Diagrama de estados - Módulo Estoque (RU)}
    \label{fig:estado_estoque_ru}
\end{figure}


\subsection{Módulo Fila Virtual}
A Figura~\ref{fig:estado_fila} ilustra os estados do objeto VagaNaFila.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{diagramas/Diagramas de estado/Fila.png}
    \caption{Diagrama de estados - Módulo Fila Virtual}
    \label{fig:estado_fila}
\end{figure}



\subsection{Módulo Nutrição e Qualidade}
A Figura~\ref{fig:estado_nutricao} detalha os estados do processo de aprovação de qualidade.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{diagramas/Diagramas de estado/NutriQuali.png}
    \caption{Diagrama de estados - Módulo Nutrição e Qualidade}
    \label{fig:estado_nutricao}
\end{figure}

\newpage
\section{Diagramas de Atividade}

Os diagramas de atividade modelam os fluxos de trabalho e processos de negócio.

\subsection{Módulo Estoque}
As Figuras~\ref{fig:atividade_estoque},~\ref{fig:atividade_estoque_ppc} e~\ref{fig:atividade_estoque_relatorio} ilustram os fluxos de atividades para o pedido de insumos, pedido PPC e geração de relatórios.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{diagramas/Diagramas de atividade/Diagrama Pedido Insumos Atividades.jpg}
    \caption{Diagrama de atividades - Módulo Estoque (Pedido de Insumos)}
    \label{fig:atividade_estoque}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{diagramas/Diagramas de atividade/Diagrama Pedido PPC Atividades.jpg}
    \caption{Diagrama de atividades - Módulo Estoque (Pedido PPC)}
    \label{fig:atividade_estoque_ppc}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{diagramas/Diagramas de atividade/Diagrama Relatório Atividades.jpg}
    \caption{Diagrama de atividades - Módulo Estoque (Relatório Atividades)}
    \label{fig:atividade_estoque_relatorio}
\end{figure}

\subsection{Módulo Fila Virtual}
A Figura~\ref{fig:atividade_fila} detalha o fluxo de atividades para a fila virtual.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{diagramas/Diagramas de atividade/Fila.png}
    \caption{Diagrama de atividades - Módulo Fila Virtual}
    \label{fig:atividade_fila}
\end{figure}



\subsection{Módulo Nutrição e Qualidade}
A Figura~\ref{fig:atividade_nutricao} mostra o fluxo de atividades para o controle de qualidade.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{diagramas/Diagramas de atividade/NutriQuali.png}
    \caption{Diagrama de atividades - Módulo Nutrição e Qualidade}
    \label{fig:atividade_nutricao}
\end{figure}

\newpage
\section{Diagramas de Sequência}

Esta seção contém os diagramas de sequência, detalhando as interações entre atores e objetos.

\subsection{Módulo Estoque}
As Figuras~\ref{fig:sequencia_estoque},~\ref{fig:sequencia_estoque_ppc} e~\ref{fig:sequencia_estoque_relatorio} detalham as interações nos processos de pedido de insumos, pedido PPC e geração de relatórios.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{diagramas/Diagramas de sequência/Diagrama Pedido Insumos Sequência.jpg}
    \caption{Diagrama de sequência - Módulo Estoque (Pedido de Insumos)}
    \label{fig:sequencia_estoque}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{diagramas/Diagramas de sequência/Diagrama Pedido PPC Sequência.jpg}
    \caption{Diagrama de sequência - Módulo Estoque (Pedido PPC)}
    \label{fig:sequencia_estoque_ppc}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{diagramas/Diagramas de sequência/Diagrama Relatório Sequência.jpg}
    \caption{Diagrama de sequência - Módulo Estoque (Relatório)}
    \label{fig:sequencia_estoque_relatorio}
\end{figure}

\subsection{Módulo Fila Virtual}
A Figura~\ref{fig:sequencia_fila} apresenta a sequência de mensagens para a fila.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{diagramas/Diagramas de sequência/Fila.png}
    \caption{Diagrama de sequência - Módulo Fila Virtual}
    \label{fig:sequencia_fila}
\end{figure}


\subsection{Módulo Nutrição e Qualidade}
A Figura~\ref{fig:sequencia_nutricao} ilustra a sequência de interações para a nutrição.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{diagramas/Diagramas de sequência/NutriQuali.jpg}
    \caption{Diagrama de sequência - Módulo Nutrição e Qualidade}
    \label{fig:sequencia_nutricao}
\end{figure}

\newpage
\section{Dificuldades e Futuras Melhorias}

Durante o desenvolvimento deste projeto, optou-se por uma abordagem modularizada para dividir as responsabilidades entre os membros do grupo. No entanto, essa divisão acabou sendo excessiva, o que resultou em uma integração dos três módulos (Fila Virtual, Estoque e Nutrição/Qualidade) mais desconexa do que o ideal. Para trabalhos futuros, uma comunicação mais constante e uma etapa de integração mais robusta seriam necessárias para garantir uma coesão maior entre as partes do sistema.

Além disso, identificamos erros técnicos na elaboração de alguns diagramas. Um exemplo específico ocorre no diagrama de sequência do módulo de Fila Virtual, onde o comprimento das barras de ativação dos métodos não reflete com precisão o tempo de execução ou o escopo de vida das chamadas, fugindo um pouco da notação padrão UML. Esses pontos de atenção servem como aprendizado para o aprimoramento da modelagem em iterações futuras.
